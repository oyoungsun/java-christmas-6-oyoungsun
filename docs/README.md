...
- [ ] 주문하실 메뉴와 개수를 받는다.
  ...
  - 메뉴가 메뉴판에 없는 경우 : "[ERROR] 유효하지 않은 주문입니다. 다시 입력해 주세요."
  - [ ] 하나의 메뉴는 ```1```개 이상, 주문의 최대 개수는 ```20```개이다.
  - 이외의 입력값의 경우 : "[ERROR] 유효하지 않은 주문입니다. 다시 입력해 주세요."
  - [ ] **[EVENT]** 음료만 받는 경우 : [ERROR] "음료만 주문 시, 주문할 수 없습니다."
  - [ ] **[EVENT]** 메뉴가 최대 20개가 넘는 경우 : "[ERROR] 메뉴는 한 번에 최대 20개까지만 주문할 수 있습니다."
